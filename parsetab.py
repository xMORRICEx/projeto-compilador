...
_lr_productions = [
  ...
  ('expressao -> termo ADD termo','expressao',3,'p_expressao','code.py',79),
  ('expressao -> termo SUB termo','expressao',3,'p_expressao','code.py',80),
  ('expressao -> termo MULT termo','expressao',3,'p_expressao','code.py',81),
  ('expressao -> termo DIV termo','expressao',3,'p_expressao','code.py',82),
  ('expressao -> IDENTIFICADOR','expressao',1,'p_expressao','code.py',83),
  ('expressao -> NUMERO','expressao',1,'p_expressao','code.py',84),
  ('termo -> IDENTIFICADOR','termo',1,'p_termo','code.py',133),
  ('termo -> NUMERO','termo',1,'p_termo','code.py',134),
]
